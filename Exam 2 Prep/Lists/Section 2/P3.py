# Define a function that takes a list of integers glist as parameter and returns True
# if the list is either sorted in decreasing or increasing order. Otherwise it returns False.
